...
public interface DateTimeRepository extends JpaRepository<DateTime, DateTimeId> {
	...
	/*List<DateTime> getByPersonDateTimes_ArrangedAndPersonDateTimes_PersonDateTimeId_Person_IdIn(
			boolean b, List<Long> ids);
	String str = "select i.date, i.time_slot, count(t.PERSON_ID)\r\n" + 
	...
	List<DateTime> getDateTimeContainsAll(@Param(value = "persons") List<Long> persons, @Param(value = "personCount") Long personCount);
